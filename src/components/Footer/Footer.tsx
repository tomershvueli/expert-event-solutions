    ...
    <footer className="flex w-full bg-wheat p-[80px] gap-[40px] sm:flex-col sm:p-[16px] sm:gap-[26px]">
      <div className="flex flex-col gap-[40px] sm:gap-[26px]">
        <div className="flex flex-col gap-[24px]">
          <p className="font-text text-[20px] font-normal leading-[26px] tracking-[-0.02em] text-left sm:font-text sm:text-[20px] sm:font-normal sm:leading-[26px] sm:tracking-[-0.02em] sm:text-center ">
            Expert Event Solutions
          </p>
          <p
            className="font-text text-[20px] font-normal leading-[26px] tracking-[-0.02em] text-left sm:font-text sm:text-[20px] sm:font-normal sm:leading-[26px] sm:tracking-[-0.02em] sm:text-center  cursor-pointer"
